...
const VideoCut = () => {
  ...
  const [startAt, setStartAt] = useState(moment("00:00:00", "HH:mm:ss"));
  const [endAt, setEndAt] = useState(moment("00:01:00", "HH:mm:ss"));
  ...
  return (
    <div style={{ margin: 20, textAlign: "center" }}>
      <TitleSection
        title='Video Cut'
        subtitle='Cut your video file.'
        img='assets/images/video_cut.svg'
      />
      <Divider />
      ...
      {videoSrc !== null && (
        <Row direction='vertical' align='center'>
          ...
          <Col xs={6}>
            <Typography.Text>
              Choose the start point and end point to crop (i.e. 00:00:00 and
              00:01:10) . It is formatted as hour:min:seg .
            </Typography.Text>
            <TimePicker
              prefix='Start time:'
              value={startAt}
              onChange={setStartAt}
            />
            <TimePicker prefix='End time:' value={endAt} onChange={setEndAt} />
          </Col>
          <Col xs={6} />
        </Row>
      )}
